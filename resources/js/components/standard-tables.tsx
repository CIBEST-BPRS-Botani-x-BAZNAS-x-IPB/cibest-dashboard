                            ...
                            {povertyStandards.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-center">
                                        {item.index_kesejahteraan_cibest !==
                                        null
                                            ? item.index_kesejahteraan_cibest.toFixed(
                                                  2,
                                              )
                                            : '-'}
                                    </td>
                        ...
                        <tbody>
                            {povertyStandards.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2">{item.name}</td>
                                    <td className="px-4 py-2 text-center">
                                        {item.nilai_keluarga !== null
                                            ? formatRupiah(item.nilai_keluarga)
                                            : '-'}
                                    </td>
                                    <td className="px-4 py-2 text-center">
                                        {item.nilai_per_tahun !== null
                                            ? formatRupiah(item.nilai_per_tahun)
                                            : '-'}
                                    </td>
                                </tr>
                            ))}
